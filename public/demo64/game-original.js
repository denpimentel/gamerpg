...
(function () {
  ...
  function preload() {
    ...
    this.load.image('meadow-turtle-idle', A + 'creatures/campo/meadow_turtle/idle.png?v=cartoon1');
    this.load.spritesheet('meadow-turtle-walk', A + 'creatures/campo/meadow_turtle/walk.png?v=cartoon1', { frameWidth: 192, frameHeight: 192 });
    this.load.spritesheet('meadow-turtle-attack', A + 'creatures/campo/meadow_turtle/attack.png?v=cartoon1', { frameWidth: 192, frameHeight: 192 });
